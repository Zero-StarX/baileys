# <div align='center'>Baileys - Typescript/Javascript WhatsApp</div>
...
```json
"dependencies": {
    "@whiskeySockets/baileys": "github:Zero-StarX/baileys"
}
```
or install in terminal:
```
npm install @whiskeySockets/baileys@github:Zero-StarX/baileys
```
...
## Reporting Issues
If you encounter any issues while using this repository or any part of it, please feel free to open a [new issue](https://github.com/Zero-StarX/baileys/issues) here.
